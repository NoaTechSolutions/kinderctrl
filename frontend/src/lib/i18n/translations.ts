...
export const translations = {
  en: {
    ...
    children: {
      ...
      // /children list view toggle (DIRECTOR/SA desktop)
      viewToggle: 'View as',
      viewTable: 'Table view',
      viewCards: 'Card view',
      ...
      // long age (child card, formatAgeLong): "4 years old" / "8 months old"
      ageYearOld: 'year old',
      ageYearsOld: 'years old',
      ageMonthOld: 'month old',
      ageMonthsOld: 'months old',
      // child card — attendance band (today)
      attPresent: 'Present',
      attEndOfShift: 'End of shift',
      attNotArrived: 'Not arrived yet',
      attNotScheduled: 'Not scheduled',
      ...
      attNoRecord: 'No record',
      attNotAttending: 'Not attending today',
      // child card — contact + alert badges
      primaryTag: 'Primary',
      ...
      filterEndOfShift: 'End of shift',
      filterNotScheduled: 'Not scheduled',
      filterStatus: 'Status',
      filterAgeGroup: 'Age group',
      filterHasAllergies: 'Has allergies',
      filterInfantSleep: 'Infant sleep plan',
      clearFilters: 'Clear filters',
      ageInfants: 'Infants (0-1)',
      ageToddlers: 'Toddlers (1-3)',
      agePreschool: 'Preschool (3-5)',
      ageSchool: 'School age (5+)',
      noMatchFilters: 'No children match the selected filters',
      // table column: today's attendance + actions
      colToday: 'Today',
      colActions: 'Actions',
      // row/card actions kebab
      actionsMenu: 'Actions',
      actionView: 'View profile',
      actionEdit: 'Edit',
      actionWithdraw: 'Withdraw',
      withdrawConfirmTitle: 'Withdraw this child?',
      withdrawConfirmDesc:
        "They'll be removed from the active roster. You can re-enroll them later.",
      withdrawnToast: 'Child withdrawn',
      withdrawError: 'Could not withdraw child',
  ...
  es: {
    ...
    children: {
      ...
      // toggle de vista del listado /children (DIRECTOR/SA desktop)
      viewToggle: 'Ver como',
      viewTable: 'Vista tabla',
      viewCards: 'Vista tarjetas',
      ...
      // edad larga (tarjeta del niño, formatAgeLong): "4 años" / "8 meses"
      ageYearOld: 'año',
      ageYearsOld: 'años',
      ageMonthOld: 'mes',
      ageMonthsOld: 'meses',
      // tarjeta del niño — banda de asistencia (hoy)
      attPresent: 'Presente',
      attEndOfShift: 'Fin de jornada',
      attNotArrived: 'Aún no llegó',
      attNotScheduled: 'Sin asistencia',
      attEarlyDeparture: 'Salida anticipada',
      attCheckIn: 'Entrada',
      attCheckOut: 'Salida',
      attNoRecord: 'Sin registro',
      attNotAttending: 'No asiste hoy',
      // tarjeta del niño — contacto + badges de alerta
      ...
      quickFiltersAria: 'Filtros rápidos',
      filterAll: 'Todos',
      filterPresent: 'Presente',
      filterNotArrived: 'No llegó',
      filterEndOfShift: 'Fin de jornada',
      filterNotScheduled: 'Sin asistencia',
      filterStatus: 'Estado',
      filterAgeGroup: 'Grupo de edad',
      filterHasAllergies: 'Con alergias',
      filterInfantSleep: 'Plan de sueño infantil',
      clearFilters: 'Limpiar filtros',
      ageInfants: 'Bebés (0-1)',
      ageToddlers: 'Pequeños (1-3)',
      agePreschool: 'Preescolar (3-5)',
      ageSchool: 'Escolar (5+)',
      noMatchFilters: 'Ningún niño coincide con los filtros seleccionados',
      // columna de tabla: asistencia de hoy + acciones
      colToday: 'Hoy',
      colActions: 'Acciones',
      // kebab de acciones (fila/tarjeta)
      actionsMenu: 'Acciones',
      actionView: 'Ver perfil',
      actionEdit: 'Editar',
      actionWithdraw: 'Dar de baja',
      withdrawConfirmTitle: '¿Dar de baja a este niño?',
      withdrawConfirmDesc:
        'Se quitará del listado activo. Podés reinscribirlo más tarde.',
      withdrawnToast: 'Niño dado de baja',
      withdrawError: 'No se pudo dar de baja al niño',
